  ...
  if (linetype == TRUE) {
    if (type == "D") {
      ggplot2::ggplot(melten.Prob) +
        ggplot2::geom_line(ggplot2::aes(x = p, y = P_D, group = Sampling_scheme, colour = Sampling_scheme)) +
      ...
      ggplot2::ggplot(melten.Prob) +
        ggplot2::geom_line(ggplot2::aes(x = p, y = 1 - P_D, group = Sampling_scheme, colour = Sampling_scheme)) +
        ggplot2::ylab(expression(P[ND])) +
        ggplot2::theme_classic() +
    ...
    if (type == "D") {
      ggplot2::ggplot(melten.Prob) +
        ggplot2::geom_line(ggplot2::aes(x = p, y = P_D, group = Sampling_scheme, linetype = Sampling_scheme, colour = Sampling_scheme)) +
        ggplot2::ylab(expression(P[D])) +
        ggplot2::theme_classic() +
        ggplot2::theme(plot.title = ggplot2::element_text(hjust = 0.5, size = 10), legend.position = c(0.75, 0.25)) +
        ggthemes::scale_colour_colorblind()
      ...
      ggplot2::ggplot(melten.Prob) +
        ggplot2::geom_line(ggplot2::aes(x = p, y = 1 - P_D, group = Sampling_scheme, linetype = Sampling_scheme, colour = Sampling_scheme)) +
        ggplot2::ylab(expression(P[ND])) +
        ggplot2::theme_classic() +
        ggplot2::theme(plot.title = ggplot2::element_text(hjust = 0.5, size = 10), legend.position = c(0.75, 0.75)) +
        ggthemes::scale_colour_colorblind()
